...
export const metadata: Metadata = {
  title: "F1 Teams Hub - Formula 1 Constructor Teams & Cars",
  description: "Explore Formula 1 teams, drivers, and cutting-edge car technology. Get the latest F1 news, team stats, and championship insights.",
  keywords: "Formula 1, F1 teams, race cars, motorsport, championship, drivers, constructors",
  ...
  openGraph: {
    ...
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763649913122-rz74ksjl.jpg",
  ...
  twitter: {
    ...
    title: "F1 Teams Hub - Formula 1 Constructor Teams & Cars",
    description: "Explore Formula 1 teams, drivers, and cutting-edge car technology.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763649913122-rz74ksjl.jpg"]
  },
  robots: {
    index: true,
    follow: true
